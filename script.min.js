...
if (langBtn && langDropdown) {
    ...
    const toggleDropdown = (e) => {
        ...
        const rect = langDropdown.getBoundingClientRect();
        const computed = window.getComputedStyle(langDropdown);
        console.log('Dropdown display:', computed.display);
        console.log('Dropdown position:', computed.position);
        console.log('Dropdown top:', computed.top);
        console.log('Dropdown right:', computed.right);
        console.log('Dropdown rect:', rect);
        console.log('Dropdown width:', rect.width, 'height:', rect.height);
        console.log('Dropdown background:', computed.background);
    };
